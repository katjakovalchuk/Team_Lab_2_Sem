...
def get_presentation_by_name(db: Session, presentation_name: str) -> Presentation_db:
...
def get_slide_by_id(db: Session, slide_id: int, presentation_name: str) -> Slide_db:
